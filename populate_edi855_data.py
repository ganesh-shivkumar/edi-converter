...
def get_database(databaseName : string):
...
edi855JsonDb = get_database("edi855_edi_json_data")
timestampStr = datetime.now().strftime("%Y-%m-%d %H:%M:%S")

dataCollection = edi855JsonDb["edi855_edi_json_data"]
timestampCollection = edi855JsonDb["timestamp"]
